...
def report_multi_pairings(data, column_a, column_b, report_by):
...
@click.option('--report_by', '-r',
              default=['column_a', 'column_b'],
              help='Which of the columns should be used for keying rows in the output?',
              multiple=True,
              type=click.Choice(['column_a', 'column_b']),
              )
def main(input_tsv, column_a, column_b, report_by):
    ...
    report_multi_pairings(data, column_a, column_b, report_by)
