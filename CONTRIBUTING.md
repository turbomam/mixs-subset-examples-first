# Contributing to mixs-subset-examples-first

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
mixs-subset-examples-first. These guidelines are not strict rules.
...
The mixs-subset-examples-first team strives to create a
...
[issues]: https://github.com/turbomam/mixs-subset-examples-first/issues/
[pulls]: https://github.com/turbomam/mixs-subset-examples-first/pulls/
