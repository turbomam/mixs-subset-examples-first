...
gen-examples:
	cp src/data/examples/valid/BiosampleCollection*.yaml $(EXAMPLEDIR)
...
examples/output: src/mixs_subset_examples_first/schema/mixs_subset_examples_first.yaml
	mkdir -p $@
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/mixs_subset_examples_first/schema/*yaml src/*/datamodel/*py src/data src/docs tests src/*/_version.py project/reports/ src/local_schemasheets/
