...
from mixs_subset_examples_first.datamodel.mixs_subset_examples_first import Database, Agriculture
...
MAIN_SCHEMA_CLASS_NAME = Database.class_name
    ...
    def test_data(self):
        ...
        for path in EXAMPLE_FILES:
            if path.startswith(ACCEPTABLE_PREFIX):
                obj = yaml_loader.load(path, target_class=Database)
                assert obj
            else:
                print()
